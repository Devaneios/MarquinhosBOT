...
// 'connect-four' isn't in GameId yet — that union is a shared file this
// game deliberately doesn't touch (see the wiring-points note in index.ts).
// The cast is removed the same moment the registry PR adds the id.
