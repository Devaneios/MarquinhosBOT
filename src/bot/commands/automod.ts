    ...
    switch (subcommand) {
      case 'configure':
        ...
        const embed = interaction.client.baseEmbed()
          ...
          .addFields(
            { name: 'Detecção de Spam', value: spamDetection ? '✅ Ativada' : '❌ Desativada', inline: true },
            { name: 'Cargos Automáticos', value: autoRoles ? '✅ Ativado' : '❌ Desativado', inline: true }
          );
      ...
      case 'logs':
        const logsEmbed = interaction.client.baseEmbed()
