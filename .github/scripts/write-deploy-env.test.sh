...
grep -Fq "POSTGRES_PASSWORD='pg-password'" "$test_dir/deploy/.env"
! grep -Fq 'POSTGRES_PASSWORD=' "$test_dir/deploy/api.env"
! grep -Fq 'POSTGRES_PASSWORD=' "$test_dir/deploy/bot.env"
