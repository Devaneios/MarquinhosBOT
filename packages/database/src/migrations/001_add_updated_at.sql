...
-- user_levels
ALTER TABLE user_levels ADD COLUMN updated_at INTEGER;
...
-- user_stats
ALTER TABLE user_stats ADD COLUMN updated_at INTEGER;
...
ALTER TABLE user_achievements ADD COLUMN updated_at INTEGER;
