...
export const userLevelSchema: z.ZodType<UserLevel> = z.object({
  userId: z.string(),
  guildId: z.string(),
  level: z.number(),
  xp: z.number(),
...
export const addXpResultSchema: z.ZodType<AddXpResult> = z.object({
...
export const userAchievementSchema: z.ZodType<UserAchievement> = z.object({
  userId: z.string(),
  guildId: z.string(),
...
export const researchStartResponseSchema: z.ZodType<ResearchStartResponse> =
  z.object({
...
export const researchJobResponseSchema: z.ZodType<ResearchJobResponse> =
  z.object({
    jobId: z.string(),
...
export const emojiReactionResponseSchema: z.ZodType<EmojiReactionResponse> =
  z.object({
    emojis: z.array(z.string()),
  });

export const mazeViewportStateSchema: z.ZodType<MazeViewportState> = z.object({
  sessionId: z.string(),
...
export const playlistSchema: z.ZodType<Playlist> = z.object({
  id: z.string(),
  name: z.string(),
